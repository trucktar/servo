...
pub struct Node {
    ...
    style_and_layout_data: UnsafeCell<Option<StyleAndOpaqueLayoutData>>,
}
...
pub trait LayoutNodeHelpers<'dom> {
    ...
    unsafe fn init_style_and_opaque_layout_data(self, data: StyleAndOpaqueLayoutData);
    unsafe fn take_style_and_opaque_layout_data(self) -> StyleAndOpaqueLayoutData;
...
impl<'dom> LayoutNodeHelpers<'dom> for LayoutDom<'dom, Node> {
    ...
    #[inline]
    #[allow(unsafe_code)]
    unsafe fn init_style_and_opaque_layout_data(self, val: StyleAndOpaqueLayoutData) {
